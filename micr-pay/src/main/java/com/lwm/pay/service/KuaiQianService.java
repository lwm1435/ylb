...
public class KuaiQianService {
     ...
     */
    public Map<String,String> generateKqPayApiData(BigDecimal money, Integer userId, String phone){
    ...
    private String generateOrderId(){
        //时间戳
        //1. 加随机数
        //2  使用redis ： string类型中， incr
        // 202112180945123234567
        // 202112180945123234868
        //String dateStr = DateFormatUtils.format(new Date(),"yyyyMMddHHmmssSSS") + RandomStringUtils.randomNumeric(6);

        //2021121809451231
        //2021121809451232
        String dateStr = "KQ"+ DateFormatUtils.format(new Date(),"yyyyMMddHHmmssSSS")
                + stringRedisTemplate.opsForValue().increment(RedisKey.KQ_ORDER_ID_SEQ);
